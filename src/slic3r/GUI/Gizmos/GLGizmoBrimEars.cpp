...
void GLGizmoBrimEars::on_render_input_window(float x, float y, float bottom_limit)
{
    ...
    ImGui::PushStyleVar(ImGuiStyleVar_ScrollbarSize, 4.0f * f_scale);
    ...
    std::vector<wxString> text_list       = {m_desc["head_diameter"], m_desc["max_angle"], m_desc["detection_radius"], m_desc["clipping_of_view"], m_desc["create"], m_desc["remove"]};
